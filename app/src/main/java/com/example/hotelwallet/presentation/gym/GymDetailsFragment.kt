                    ...
                    is Resource.Success -> {
                        it.data.apply {
                            this[position ?: 0].apply {
                                ...
                                binding.radioOneDay.text = "${getString(R.string.txt_one_day)} ${
                                    getString(R.string.txt_price_value).format(price)
                                }"
                                binding.radioTwoDay.text = "${getString(R.string.txt_two_day)} ${
                                    getString(R.string.txt_price_value).format(price.toFloat() * 2)
                                }"
                                binding.radioThreeDay.text =
                                    "${getString(R.string.txt_three_day)} ${
                                        getString(R.string.txt_price_value).format(price.toFloat() * 3)
                                    }"
                                binding.radioFourDay.text = "${getString(R.string.txt_four_day)} ${
                                    getString(R.string.txt_price_value).format(price.toFloat() * 4)
                                }"
                                binding.radioFiveDay.text = "${getString(R.string.txt_five_day)} ${
